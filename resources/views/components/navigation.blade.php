...
@if ($menu->isNotEmpty())
<nav class="w-full z-30 top-0 py-1 lg:relative" role="navigation" aria-label="Main navigation">
    <div class="w-full container mx-auto max-w-6xl flex flex-wrap items-center justify-between mt-0 px-8 py-1">
