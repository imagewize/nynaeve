<div class="container mx-auto max-w-6xl">
  <article @php(post_class('lg:grid lg:grid-cols-12 lg:gap-4 mb-12 mx-5 md:mx-none'))>
    ...
    <div class="col-span-2 flex justify-center items-start pt-2">
      <div class="hidden lg:flex rounded-full overflow-hidden w-24 h-24 border-8 border-border-dark">
    ...
    <div class="col-span-4 entry-summary font-open-sans text-base leading-loose text-secondary">
      @php(the_excerpt())
    </div>
    ...
    <div class="col-span-2 hidden lg:flex items-start justify-center pt-2">
      ...
      uppercase tracking-wide border-b-4 border-border-dark">
        Read More
      </a>
    </div>
  </article>
