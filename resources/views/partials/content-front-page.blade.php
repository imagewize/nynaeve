...
@if(have_rows('homepage_builder'))
    @while(have_rows('homepage_builder'))
        ...
        @if(get_row_layout() == 'about_block')
            <section id="about" class="py-24 bg-border-light">
                <div class="container mx-auto max-w-5xl px-4">
                    <div class="flex flex-col md:flex-row gap-8">
                        <div class="md:w-1/4 w-full">
                            <div id="about-profile" class="rounded-full overflow-hidden w-24 h-24 border-8 border-border-dark mx-auto">
                        ...
                        <div class="md:w-3/4 w-full">
                            ...
                            <p class="text-xl leading-relaxed font-light mb-6 text-secondary font-open-sans">{{ get_sub_field('about_lead') }}</p>
                            <div class="prose text-secondary text-base leading-loose font-open-sans">{!! get_sub_field('about_text') !!}</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="services" class="py-16 bg-gray-50">
                <div class="container mx-auto max-w-4xl px-4">
                    <div class="mb-12">
                        ...
                        <p class="mx-auto  max-w-2xl text-xl leading-relaxed my-8 text-center text-secondary font-open-sans font-light container">
                        ...
                        @while(have_rows('services_boxes'))
                            ...
                            <div class="service-block bg-white p-6 rounded-lg group hover:cursor-pointer">
                                <div class="grid grid-cols-[auto_1fr] gap-4 items-start">
                                    <span class="service-icon inline-flex p-2 text-3xl bg-primary rounded-lg 
                                    ...
                                    <h3 class="service-title text-lg text-primary group-hover:text-gray-700 font-semibold relative inline-block">
                                        <span class="relative inline-block">
                                            {{ get_sub_field('text_box_title') }}
                                            <span class="absolute -bottom-2 left-0 w-1/4 h-[3px] bg-border-dark 
                                            group-hover:w-1/2 group-hover:bg-main-accent transition-all duration-300"></span>
                                        </span>
                                    </h3>
                                    <div class="service-body prose text-secondary font-open-sans leading-loose col-start-2">
        ...
        @elseif(get_row_layout() == 'cta_banner')
            <section id="CTA" class="py-16 bg-primary text-white">
                <div class="container mx-auto max-w-2xl px-4 text-center">
                    ...
                    bg-primary-dark hover:bg-primary-dark text-white rounded-lg font-semibold">
